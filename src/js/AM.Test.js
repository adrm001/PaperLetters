...
AM.Test.prototype = {
    ...
    init: function() {
        ...
        this.points[0] = new AM.SvgPoint(50, 150, null);
        this.points[1] = new AM.SvgPoint(200, 150, this.points[0]);
        this.points[2] = new AM.SvgPoint(300, 50, this.points[1]);
        this.points[1].dragMove();
    },
    AMLogo: function() {
        ...
        var AMpoints = [[0, 0], [49, -170], [100, 0], [150, -30], [125, -170], [75, -50], [80, -58], [10, -58]];
        AMpoints.forEach(function(elem) {
            var x = elem[0] + 150;
            var y = elem[1] + 200;
            var point = new AM.SvgPoint(x, y, this.points[this.points.length - 1]);
            point.dragMove();
    ...
    addPoint: function () {
        ...
        var x = prev ? prev.point.x + 15 : 50;
        var y = prev ? prev.point.y + 15 : 50;

        this.points[this.points.length] = new AM.SvgPoint(x,y,this.points[this.points.length - 1]);
    },
